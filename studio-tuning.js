...
const defs={
 whiteSweep:[control('period','重复周期',.6,2.5,.05,1.1,'秒'),control('motionStart','起步速度',.2,3,.05,1,'×'),control('motionMiddle','中段速度',.2,3,.05,1,'×'),control('motionEnd','收尾速度',.2,3,.05,1,'×'),control('motionPeak','变速重心',.15,.85,.01,.5,'进度'),{...control('motionSoftness','加减速柔和度',0,1,.05,1),legacyValue:0},{...control('direction','移动方向',0,3,1,0),kind:'select',options:[[0,'右 → 左'],[1,'左 → 右'],[2,'上 → 下'],[3,'下 → 上']]},control('tilt','倾斜角度',-60,60,1,0,'°'),control('headWidth','主光团宽度',3,10,.25,6,'灯距'),control('headUpper','上部饱满度',0,2,.05,1,'×'),control('headMiddle','中部饱满度',0,2,.05,1,'×'),control('headLower','下部饱满度',0,2,.05,1,'×'),control('starGap','残星离主团距离',0,12,.25,0,'灯距'),control('starWidth','拖尾展开宽度',1,8,.25,8,'排'),control('starUpper','上部饱满度',0,2,.05,1,'×'),control('starMiddle','中部饱满度',0,2,.05,1,'×'),control('starLower','下部饱满度',0,2,.05,1,'×'),control('starDensity','残星数量',.04,1,.01,.09),control('starLife','残星消散',.2,8,.02,.8,'秒'),control('starBrightness','残星亮度',.15,.9,.05,.85,'×')],
